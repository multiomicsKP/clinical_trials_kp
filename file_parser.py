...
def load_data(data_folder):
    edges_file_path = os.path.join(data_folder, "clinical_trials_kg_edges_v3.1.26.tsv")
    nodes_file_path = os.path.join(data_folder, "clinical_trials_kg_nodes_v3.1.26.tsv")
