...
def load_data(data_folder):
    edges_file_path = os.path.join(data_folder, "clinical_trials_kg_edges_v2.7.14.tsv")
    nodes_file_path = os.path.join(data_folder, "clinical_trials_kg_nodes_v2.7.14.tsv")
